...
required="updater:default process:default core:default core:window:allow-hide core:window:allow-show core:window:allow-minimize core:window:allow-toggle-maximize core:window:allow-close core:window:allow-start-dragging opener:allow-open-url opener:allow-reveal-item-in-dir clipboard-manager:allow-write-text"
