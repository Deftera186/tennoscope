...
function RewardPage({ view }: { view: AppView }) {
  return <div className="page"><div className="page-heading"><div><p className="eyebrow">Decision support</p><h1 id="reward-title">Reward advisor</h1><p>TennoScope watches the active Warframe display and places advice below the reward row.</p></div><span className="snapshot-mark">Automatic · click through</span></div>
